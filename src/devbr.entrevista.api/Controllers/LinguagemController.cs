...
namespace DevBr.Entrevista.Api.Controllers
{
    ...
    {
        private readonly ILinguagemAppService _service;

        public LinguagemController(ILinguagemAppService service)
        {
          _service = service;
        }

        [HttpPost]
        public IActionResult Create([FromBody] LinguagemViewModel viewModel)
        {
            var result = _service.Adicionar(viewModel);
            var response = new ResponseResultCore<LinguagemViewModel>(HttpStatusCode.Created, result);
        ...
        public IActionResult Listar()
        {
            ...
            var response = new ResponseResultCore<List<LinguagemViewModel>>(HttpStatusCode.OK, result);
            return Ok(response);
        }
        ...
        public IActionResult Consultar([FromQuery] Guid Id)
        {
            ...
            var response = new ResponseResultCore<LinguagemViewModel>(HttpStatusCode.OK, result);
            return Ok(response);
        }

        [HttpPut]
        public IActionResult Atualizar([FromBody] LinguagemViewModel viewModel)
        {
